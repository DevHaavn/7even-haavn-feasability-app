...
.ath-burger.on::before{left:12px;clip-path:polygon(0 0,23% 0,100% 50%,23% 100%,0 100%,77% 50%)}
.ath-burger.on::after{right:12px;clip-path:polygon(100% 0,77% 0,0 50%,77% 100%,100% 100%,23% 50%)}
