...
export interface Meeting {
  ...
  // Outlook calendar sync (Graph)
  organizer?: string            // mailbox the event lives on (default boardroom@haavn.au)
  calendarEventId?: string      // Graph event id once pushed
  teamsJoinUrl?: string         // Teams online-meeting link generated by the event
  webLink?: string              // Outlook web link to the event
}
