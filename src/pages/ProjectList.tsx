...
.ath-burger span{display:block;width:4px;height:22px;background:#967d4a;box-shadow:0 0 8px rgba(150,125,74,.5);transition:.3s;border-radius:1px}
.ath-burger span:nth-child(2){display:none}
.ath-burger:hover span,.ath-burger.on span{background:#d6b36a;box-shadow:0 0 10px rgba(214,179,106,.8),0 0 22px rgba(214,179,106,.45)}
...
.ath-burger.on::before,.ath-burger.on::after{content:'';position:absolute;top:50%;width:13px;height:22px;transform:translateY(-50%);
  background:#d6b36a;filter:drop-shadow(0 0 8px rgba(214,179,106,.7)) drop-shadow(0 0 18px rgba(214,179,106,.4));transition:.3s}
